  ...
  projects: [
    {
      ...
      featured: true,
      links: {
        live: 'https://orbit-8n3dre0ga-core-ctrls-projects.vercel.app/',
        github: 'https://github.com/core-ctrl/Orbit',
        demo: null,
      },
      highlights: [
        'Real-time incident tracking with Socket.IO & Redis Pub/Sub for live crash reporting and telemetry feeds',
        'Bidirectional SDK control via FastAPI, enabling real-time remote configuration (like dynamic sampling rates) without code redeploys',
        'High-volume observability ingestion pipeline using Python and PostgreSQL to process logs, distributed traces, and source maps',
        'Premium glassmorphism dashboard built with Next.js 15, Recharts, and Tailwind CSS for responsive data visualization',
        'Advanced AI Root Cause Analysis engine that automatically analyzes stack traces and generates self-healing Pull Request patches',
        'Fully containerized microservice architecture using Docker and Docker Compose (Frontend, Control Plane, Ingestion Engine)'
      ],
    },
    {
      id: 'moviefinder',
